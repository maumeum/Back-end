...
volunteerCommentRouter.post(
  '/volunteerComments',
  loginRequired,
  volunteerCommentController.postVolunteerComment
);
...
volunteerCommentRouter.get(
  ...
  volunteerCommentController.getVolunteerComment
);
...
volunteerCommentRouter.patch(
  ...
  loginRequired,
  volunteerCommentController.patchVolunteerComment
);
...
volunteerCommentRouter.delete(
  '/volunteerComments/:volunteerCommentId',
  loginRequired,
  volunteerCommentController.deleteVolunteerComment
);
